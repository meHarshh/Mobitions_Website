        ...
        <div className="text-center max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {['Zyrocraft', 'Coinflow', 'GamezHub', 'Traffhit'].map((vertical) => (
              <div key={vertical} className="px-4 py-2 bg-muted/50 rounded-full border border-border">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16 pt-16 border-t border-border/30">
            <div className="text-center animate-pulse-scale">
              <div className="text-3xl md:text-4xl font-bold gradient-text mb-2">5,000+</div>
              <div className="text-muted-foreground">Registered Affiliates</div>
            </div>
            <div className="text-center animate-pulse-scale">
